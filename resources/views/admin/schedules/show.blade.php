    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <form action="{{ route('admin.schedules.updateStatus', $appointment) }}" method="POST" class="pt-2">
                    @csrf
                    @method('PATCH')
            ...
            <div class="space-y-3 text-sm">
                ...
                @if ($appointment->payment?->proof_image)
                    <div>
                        ...
                        <img src="{{ asset('storage/' . $appointment->payment->proof_image) }}" alt="Bukti Transfer"
