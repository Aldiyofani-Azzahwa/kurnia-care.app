...
<head>
    ...
    <meta name="description" content="Kurnia Care adalah klinik khitan modern dengan pendaftaran online, pelayanan profesional, dan pendekatan ramah anak.">
    ...
    .kc-section { scroll-margin-top: 92px; }
...
<body class="kc-page-bg overflow-x-hidden text-gray-800 antialiased">
    ...
    <div class="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-emerald-100/50 blur-3xl"></div>
        ...
        >
            <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                <a href="#beranda" class="flex items-center gap-3">
                    <img src="{{ $logo }}" alt="Logo Kurnia Care" class="h-12 w-12 rounded-full bg-white object-contain shadow-sm ring-1 ring-gray-200">
                    <div>
                ...
                <div class="hidden items-center gap-7 lg:flex">
                    @foreach ($navItems as $item)
                        <a href="{{ $item['target'] }}" class="text-sm font-semibold text-gray-600 transition hover:text-emerald-700">
                            {{ $item['label'] }}
                        </a>
                    @endforeach
                </div>
                ...
                <div class="hidden items-center gap-3 lg:flex">
                    <a href="{{ $loginUrl }}" class="rounded-xl px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-100">
                        Masuk
                    </a>
                    <a href="{{ $bookingUrl }}" class="rounded-xl bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800 hover:shadow-md">
                        Daftar Sekarang
                    </a>
                </div>
            ...
            <div x-cloak x-show="mobileOpen" x-transition class="border-t border-gray-100 bg-white/95 px-4 py-4 shadow-lg lg:hidden">
                <div class="space-y-1">
                    @foreach ($navItems as $item)
                        <a href="{{ $item['target'] }}" @click="mobileOpen = false" class="block rounded-xl px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-700">
                            {{ $item['label'] }}
                        </a>
                    @endforeach
                </div>
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    <a href="{{ $loginUrl }}" class="rounded-xl border border-gray-200 px-4 py-3 text-center text-sm font-semibold text-gray-700">
                        Masuk
                    </a>
                    <a href="{{ $bookingUrl }}" class="rounded-xl bg-emerald-700 px-4 py-3 text-center text-sm font-semibold text-white">
                        Daftar
                    </a>
                </div>
            </div>
        ...
        <main class="relative z-10">
            <section id="beranda" class="kc-section kc-hero-bg relative isolate overflow-hidden pt-28 sm:pt-32 lg:pt-36">
    ...
    <div class="mx-auto grid max-w-7xl items-center gap-12 px-4 pb-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:pb-28">
        <div class="reveal">
            <div class="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-white/85 px-4 py-2 text-sm font-semibold text-emerald-800 shadow-sm backdrop-blur">
                <span class="h-2 w-2 rounded-full bg-amber-400"></span>
                Pendaftaran khitan modern lebih mudah
            </div>

            <h1 class="mt-7 max-w-3xl text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            ...
            <p class="mt-6 max-w-2xl text-base leading-8 text-gray-600 sm:text-lg">
                Pendaftaran online yang mudah dengan pelayanan profesional dan pendekatan yang ramah terhadap anak dan keluarga.
            </p>
        ...
        <div class="reveal">
            <div class="kc-hero-panel kc-gold-glow mx-auto max-w-lg rounded-[2rem] p-5">
                <div class="relative overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-emerald-900 via-emerald-700 to-amber-500 p-6 text-white">
                    <div class="pointer-events-none absolute right-0 top-0 h-32 w-32 rounded-full bg-white/10 blur-2xl"></div>
                    <div class="pointer-events-none absolute bottom-0 left-0 h-28 w-28 rounded-full bg-amber-200/20 blur-2xl"></div>
                    ...
                    @foreach (['Daftar akun', 'Lengkapi data anak', 'Upload bukti pembayaran'] as $index => $item)
                        <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                            <div class="flex items-center gap-3">
                                <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-100 text-sm font-bold text-amber-700">
                                    {{ $index + 1 }}
                                </div>
            ...
            <section class="bg-gradient-to-b from-white via-emerald-50/40 to-white py-16">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div class="reveal kc-premium-card rounded-3xl p-6 transition hover:-translate-y-1 hover:shadow-md">
                            <p class="text-4xl font-bold text-emerald-700"><span data-counter="{{ $handledPatients }}">0</span>+</p>
            ...
            <section id="mengapa" class="kc-section bg-gradient-to-br from-white via-gray-50 to-emerald-50/50 py-20">
                <div class="pointer-events-none absolute right-0 top-10 h-64 w-64 rounded-full bg-emerald-100/70 blur-3xl"></div>
                <div class="pointer-events-none absolute bottom-10 left-0 h-52 w-52 rounded-full bg-amber-100/70 blur-3xl"></div>
                ...
                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        @foreach ($whyCards as $card)
                            <div class="reveal group rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                                <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-50 text-amber-600 transition group-hover:bg-emerald-700 group-hover:text-white">
            ...
            <section id="dokter" class="kc-section bg-gradient-to-br from-emerald-50/80 via-white to-emerald-100/40 py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="reveal max-w-2xl">
        ...
        <div class="reveal mt-10 rounded-[2rem] border border-gray-100 bg-white p-4 shadow-sm sm:p-5 lg:p-6">
            <div class="grid gap-6 lg:grid-cols-[340px_1fr] lg:items-stretch">
                <div class="overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-50 via-white to-amber-50 shadow-sm ring-1 ring-gray-100">
                    @if ($featuredDoctor && $featuredDoctor->photo)
                        <img
                            src="{{ asset('storage/' . $featuredDoctor->photo) }}"
                ...
                <div class="flex flex-col justify-center rounded-3xl bg-gradient-to-br from-white via-white to-emerald-50/60 p-5 sm:p-7 lg:p-8">
                    <div class="inline-flex w-fit rounded-full bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-700">
            ...
            <section id="layanan" class="kc-section relative overflow-hidden bg-gradient-to-br from-white via-amber-50/45 to-white py-20">
    <div class="pointer-events-none absolute left-0 top-20 h-64 w-64 rounded-full bg-emerald-100/70 blur-3xl"></div>
    <div class="pointer-events-none absolute bottom-24 right-0 h-72 w-72 rounded-full bg-amber-100/70 blur-3xl"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="reveal flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <a href="{{ $bookingUrl }}" class="inline-flex rounded-2xl bg-emerald-700 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-800">
                Daftar Sekarang
            </a>
        </div>
        ...
        <div x-data="{ showAll: false, previewImage: null, previewTitle: '' }" class="mt-10">
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                @forelse ($services as $index => $service)
                    ...
                    >
                        <div class="relative overflow-hidden bg-emerald-50">
                            ...
                            @else
                                <div class="aspect-[4/3] w-full bg-gradient-to-br from-emerald-700 via-emerald-600 to-amber-400">
                            ...
                            <div class="absolute left-4 top-4 rounded-full bg-white/90 px-3 py-1 text-xs font-bold text-emerald-700 shadow-sm">
                                Layanan Khitan
                            </div>
                        </div>
                ...
                @empty
                    <div class="reveal rounded-3xl border border-dashed border-gray-200 bg-white p-8 text-center md:col-span-2 lg:col-span-3">
            ...
            >
                ...
                >
                    ...
                    <div class="rounded-[1.5rem] bg-gray-100 p-3">
                        ...
                        <p x-text="previewTitle" class="mt-3 text-center text-sm font-bold text-gray-800"></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-12 grid gap-4 md:grid-cols-3 lg:grid-cols-6">
                        @foreach ($steps as $index => $step)
                            <div class="reveal rounded-3xl border border-gray-100 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
                                <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-700 text-sm font-bold text-white">
                                    {{ $index + 1 }}
                                </div>
            ...
            <section id="jadwal" class="kc-section bg-gradient-to-br from-emerald-50/80 via-white to-amber-50/50 py-20">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="reveal rounded-[2rem] bg-gradient-to-br from-emerald-800 via-emerald-700 to-emerald-600 p-6 text-white shadow-lg ring-1 ring-amber-300/20 sm:p-8 lg:p-10">
                        <div class="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-center">
                            <div>
                                <p class="text-sm font-bold uppercase tracking-wide text-amber-200">Kuota dan Jadwal Hari Ini</p>
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-10 flex snap-x gap-5 overflow-x-auto pb-4">
                        @forelse ($testimonials as $testimonial)
                            <article class="reveal min-w-[300px] snap-start rounded-3xl border border-gray-100 bg-white p-6 shadow-sm sm:min-w-[380px]">
                                ...
                                <div class="mt-6 flex items-center gap-3">
                                    @if ($testimonial->image)
                                        <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ $testimonial->name }}" class="h-11 w-11 rounded-full object-cover">
                                    @else
                        ...
                        @empty
                            <div class="reveal w-full rounded-3xl border border-dashed border-gray-200 bg-white p-8 text-center">
                ...
                <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-10 space-y-4">
                        @foreach ($faqs as $index => $faq)
                            <div x-data="{ open: {{ $index === 0 ? 'true' : 'false' }} }" class="reveal rounded-3xl border border-gray-100 bg-white shadow-sm">
                                <button type="button" @click="open = !open" class="flex w-full items-center justify-between gap-4 px-6 py-5 text-left">
                                    ...
                                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-amber-50 text-amber-700" x-text="open ? '−' : '+'"></span>
                                </button>
            ...
            <section id="kontak" class="kc-section bg-gradient-to-b from-gray-50 via-emerald-50/40 to-white py-20">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="reveal relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-gray-950 via-emerald-950 to-gray-900 shadow-xl ring-1 ring-amber-300/20">
                        <div class="pointer-events-none absolute right-8 top-8 h-28 w-28 rounded-full bg-amber-300/10 blur-2xl"></div>
                        <div class="pointer-events-none absolute left-10 bottom-10 h-32 w-32 rounded-full bg-emerald-300/10 blur-2xl"></div>

                        <div class="relative grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.15fr_0.85fr] lg:p-10">
                            <div>
                                <p class="text-sm font-bold uppercase tracking-wide text-amber-300">Konsultasi Sekarang</p>
                                <h2 class="mt-3 max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
                                    Siap Memberikan Pengalaman Khitan Terbaik untuk Buah Hati Anda?
                                </h2>
                                <p class="mt-5 max-w-2xl leading-7 text-gray-300">
                                    Mulai dari pendaftaran online, verifikasi pembayaran, sampai tindakan dokter dalam satu sistem yang rapi.
                                </p>

                                <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                                    <a href="{{ $bookingUrl }}" class="rounded-2xl bg-emerald-600 px-6 py-3.5 text-center text-sm font-bold text-white transition hover:bg-emerald-500">
                                        Daftar Sekarang
                                    </a>
                                    <a href="{{ $whatsappUrl }}" target="_blank" rel="noopener" class="rounded-2xl bg-white px-6 py-3.5 text-center text-sm font-bold text-gray-900 transition hover:bg-amber-50">
                                        Konsultasi WhatsApp
                                    </a>
                                </div>
                            </div>

                            <div class="rounded-3xl bg-white/10 p-6 text-white backdrop-blur">
                                <img src="{{ $logo }}" alt="Logo Kurnia Care" class="h-16 w-16 rounded-full bg-white object-contain p-1 shadow-md">

                                <div class="mt-6 space-y-4 text-sm">
                                    <div>
                                        <p class="text-gray-400">Alamat</p>
                                        <p class="mt-1 font-semibold">{{ $clinicAddress }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-400">WhatsApp</p>
                                        <p class="mt-1 font-semibold">{{ $whatsappNumber }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-400">Email</p>
                                        <p class="mt-1 font-semibold">{{ $clinicEmail }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-400">Jam Operasional</p>
                                        <p class="mt-1 font-semibold">{{ $operationalHours }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="relative z-10 border-t border-gray-100 bg-white py-10">
            <div class="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                <div class="flex items-center gap-3">
                    <img src="{{ $logo }}" alt="Logo Kurnia Care" class="h-12 w-12 rounded-full object-contain ring-1 ring-gray-200">
                    <div>
