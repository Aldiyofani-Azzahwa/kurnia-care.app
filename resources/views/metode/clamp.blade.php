...
<section class="hero">
    ...
    <div class="hero-image">
        ...
        <div class="hero-content">
            ...
            <p>
                Metode clamp merupakan metode sunat modern yang menggunakan
...
<section class="section">
    ...
    <div class="info">
        ...
        <h2>Tentang Metode Clamp</h2>

        <p>
            Metode clamp menjadi salah satu metode sunat modern yang cukup populer
            ...
            <br><br>
            Selain itu, metode clamp juga memberikan hasil yang lebih rapi dan nyaman
