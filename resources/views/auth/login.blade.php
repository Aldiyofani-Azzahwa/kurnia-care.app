...
<head>
    ...
    <title>Masuk Akun - Kurnia Care</title>
...
<body class="kc-login-bg min-h-screen overflow-x-hidden font-sans text-gray-900 antialiased">
    <main class="relative min-h-screen">
        ...
        <div class="relative z-10 flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
            <div class="grid w-full max-w-6xl overflow-hidden rounded-[2rem] bg-white/55 shadow-2xl ring-1 ring-white/70 backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr]">
                ...
                <section class="relative hidden overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-700 to-amber-500 p-10 text-white lg:flex lg:flex-col lg:justify-between">
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-14 max-w-lg">
                            <p class="inline-flex rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-emerald-50 backdrop-blur">
                                Dashboard Pasien, Dokter, dan Admin
                            </p>

                            <h2 class="mt-6 text-4xl font-bold leading-tight">
                                Masuk untuk melanjutkan layanan Kurnia Care.
                            </h2>

                            <p class="mt-5 text-base leading-8 text-emerald-50">
                                Kelola pendaftaran, jadwal, pembayaran, dokumentasi, dan pelayanan pasien dalam satu sistem yang rapi.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative grid grid-cols-3 gap-4">
                        ...
                        <div class="rounded-2xl bg-white/15 p-4 backdrop-blur">
                            <p class="text-2xl font-bold">Rapi</p>
                            <p class="mt-1 text-xs text-emerald-50">
                                Sistem digital
                            </p>
                        </div>
                    ...
                    <div class="mx-auto max-w-md">
                        ...
                        <div class="mt-10">
                            ...
                            <p class="mt-5 text-sm leading-6 text-gray-600">
                                Masukkan email dan password untuk mengakses dashboard sesuai peran akun.
                            </p>
                        </div>
                        ...
                        <div class="mt-6 rounded-2xl border border-amber-100 bg-amber-50/70 px-4 py-4">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">
                                Buat akun untuk melakukan pendaftaran layanan khitan secara online.
                            </p>
